 ...
 * 
 * import com.jujumarket.main.domain.RecommendVO; import
 * com.jujumarket.main.service.RecommendService; import
 * com.jujumarket.shop.domain.RegisterItemVO; import
 * com.jujumarket.shop.service.RegisterItemService;
 * 
 ...
 * 
 * @AllArgsConstructor public class RecommendController {
 * 
 * private RecommendService service; private RegisterItemService itemService;
 * 
 * @GetMapping(value = "/test", produces =
 * MediaType.APPLICATION_JSON_UTF8_VALUE)
 * 
 * @ResponseBody public ResponseEntity<List> test(Model model) throws
 * IOException, TasteException { log.info("Recommend Test 작동중");
 * 
 * 
 * List<RecommendedItem> recommendations = (List<RecommendedItem>)
 * service.getRecommend();
 * 
 * // for (RecommendedItem recommendation : recommendations) { //
 * System.out.println("2번 사람에게 추천 결과 [item : p00" + recommendation.getItemID() +
 * ", value : " + recommendation.getValue() + "]"); // // } List<RecommendVO>
 * result = new ArrayList<>();
 * 
 * for(int i=0; i<recommendations.size(); i++) {
 * 
 * RecommendVO vo = new RecommendVO(); vo.setItemCode("s0003p00" +
 ...
 * 
 * vo.setIdNo(item.getIdNo()); vo.setItemName(item.getItemName());
 * vo.setNormPrice(item.getNormPrice()); vo.setPrice(item.getPrice());
